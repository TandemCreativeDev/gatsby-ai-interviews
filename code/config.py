...
Ask up to around 5 questions about the respondent’s AI use outside of education. Explore how they use AI in personal contexts, such as social media, gaming, creative projects, work, or personal organization. Investigate how this compares to their academic use of AI. Remember to only ask one question at a time and keep your responses short but communicative. Do NOT ask more than 5 questions on this topic.
...
Ask no more than 5 questions about how the respondent thinks their college could use AI to support students. Explore their views on teachers using AI for lesson planning and marking. Investigate any ideas they have for improving teaching with AI, particularly online learning. The use of AI in providing careers advice and other student services. And any concerns they may have about the use of AI in education. Remember to only ask one question at a time and keep your responses short but communicative. Do NOT ask more than 5 questions on this topic.
...
Ask no more than 5 questions about AI’s broader role in society and the workplace. Explore their concerns about AI in education, society, and employment. Ask about their thoughts on AI in their future career, whether it will be important in their chosen field, and whether they feel prepared to use AI at work. Discuss any skills they believe they need to develop. Remember to only ask one question at a time and keep your responses short but communicative. Do NOT ask more than 5 questions on this topic.
...
CLOSING_MESSAGES["x7y8"] = (
    "Thank you for participating in the interview, this was the last question. IMPORTANT: It is essential that you remain on this page until seeing a confirmation that the interview has been saved. This may take up to 1 minute. Thanks again for your answers and time to help with this research project!"
)
...
MODEL = {"chat": "gpt-4o-2024-08-06", "analysis": "o4-mini"}
