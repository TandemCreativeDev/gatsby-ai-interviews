...
def setup_admin_page(title, logo_path=None):
    ...
    Args:
        ...
        logo_path (str, optional): Path to the logo.
        Defaults to config.LOGO_PATH.
    ...
    st.set_page_config(
        page_title=f"{title} | Gatsby AI Interview",
    ...
    with col2:
        # Display smaller centered image without
        # pixelation by retaining aspect ratio
